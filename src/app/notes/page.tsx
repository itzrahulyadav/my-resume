        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl">
              <h2 className="text-xl font-bold mb-2">AWS Security Best Practices</h2>
              <p className="text-gray-300 mb-4">Key notes on securing AWS infrastructure, including IAM and VPC configurations.</p>
              <a href="https://example.com/aws-security-notes" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-purple-300 transition-colors">
                View Notes
              </a>
            </div>
